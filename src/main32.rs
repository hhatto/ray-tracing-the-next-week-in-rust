...
fn two_spheres() -> HitableList {
    ...
    list.list.push(get_sphere!(Lambertian, Box::new(checker.clone()), Vec3::new(0., -10., 0.), 10.));
    list.list.push(get_sphere!(Lambertian, Box::new(checker), Vec3::new(0., 10., 0.), 10.));
    list
}
...
fn main() {
    ...
    let world: HitableList = two_spheres();
